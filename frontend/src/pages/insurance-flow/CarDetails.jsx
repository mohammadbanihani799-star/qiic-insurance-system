...
import CylindersPopup from '../../components/CylindersPopup';
import { useSocket } from '../../context/SocketContext';
import '../../styles/pages/CarDetails.css';

const QIC_FONT = 'URWGeometricArabic, PP Neue Montreal Arabic, sans-serif';
...
const CarDetails = () => {
  ...
  const [seatsPopupOpen, setSeatsPopupOpen] = useState(false);
  const [cylindersPopupOpen, setCylindersPopupOpen] = useState(false);
    ...
    const fetchModels = async () => {
      if (formData.make) {
        ...
        try {
          ...
          const uniqueModels = [...new Set(data.data || [])];
  ...
  return (
    <div className="car-details-page rtl">
      <div className="flow">
        ...
        <div className="flow__content">
          ...
          {/* Tab Section */}
          <p className="form-instruction">قم بملئ بيانات تفاصيل مركبتك</p>
          ...
          <form onSubmit={handleSubmit}>
            <div className="row-list">
              ...
              <div className="base-select-wrapper">
                <div className={`base-select-control ${formData.make ? 'base-select-control_has-value' : ''} ${loadingMakes ? 'base-select-control_disabled' : ''}`}>
                  <label className="base-select-control__label" htmlFor="make">
                    العلامة
                  </label>
                  <select
                    id="make"
                  ...
                  >
                    <option value="" disabled>{loadingMakes ? 'Loading...' : ''}</option>
                    {carMakes.map((make, index) => (
                      <option key={`make-${index}-${make}`} value={make}>{make}</option>
                    ))}
                  </select>
              ...
              <div className="base-select-wrapper" style={{ position: 'relative' }}>
                ...
                >
                  ...
                  >
                    ...
                    {[2025, 2024, 2023, 2022, 2021, 2020, 2019, 2018, 2017, 2016, 2015, 2014, 2013, 2012, 2011, 2010, 2009, 2008, 2007, 2006, 2005, 2004, 2003, 2002, 2001, 2000, 1999, 1998, 1997, 1996, 1995, 1994, 1993, 1992, 1991, 1990].map((year, index) => (
              ...
              <div className="base-select-wrapper" style={{ position: 'relative' }}>
                ...
                >
                  ...
                  >
                    <option value="" disabled></option>
                    {[2, 5, 7, 9].map((seats, index) => (
                      <option key={`seats-${index}-${seats}`} value={seats}>{seats}</option>
                    ))}
                  </select>
                  <div className="base-select-control__icon">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
              ...
              <div className="base-select-wrapper" style={{ position: 'relative' }}>
                ...
                >
                  ...
                  >
                    ...
                    {[4, 6, 8, 12].map((cylinders, index) => (
                      <option key={`cylinders-${index}-${cylinders}`} value={cylinders}>{cylinders}</option>
                    ))}
                  </select>
                  <div className="base-select-control__icon">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
      ...
      <SeatsPopup 
        isOpen={seatsPopupOpen} 
        onClose={() => setSeatsPopupOpen(false)} 
      />
      
      <CylindersPopup 
        isOpen={cylindersPopupOpen} 
        onClose={() => setCylindersPopupOpen(false)} 
      />
    </div>
  );
};
