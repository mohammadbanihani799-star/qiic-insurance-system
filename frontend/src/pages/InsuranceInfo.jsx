    ...
    <div className="insurance-info-page rtl">
      ...
      <div className="progress">
        <div className="scale-progress">
          <div className="light" style={{ width: '84%' }}></div>
          <div className="green" style={{ width: '76%' }}></div>
        </div>
        <div className="progress_text">2 خطوات للحصول على عرض السعر</div>
      </div>
        ...
        <form onSubmit={handleSubmit} className="insurance-info-form">
          <div className="row-group insured-info-container">
            <div className="row-list">
              ...
              {/* Qatar ID */}
              <div className={`input-container ${errors.qatarId ? 'input-container--error' : ''}`}>
                <div className="input-wrapper">
                  ...
                  />
                  <label className="label">رقم البطاقة القطرية</label>
                </div>
                {errors.qatarId && <span className="error-message">{errors.qatarId}</span>}
              </div>

              {/* Qatar ID Expiry Date */}
              <div className={`input-container date-input ${errors.qatarIdExpiry ? 'input-container--error' : ''}`}>
                <div className="input-wrapper">
                  <input
                    className="input"
                    type="date"
                  ...
                  />
                  <label className="label">تاريخ صلاحية البطاقة القطرية</label>
                </div>
              ...
              <div className="select-container">
                ...
                >
                  <span className="select-label">الجنس</span>
                  <div className="select-value">{formData.gender === 'male' ? 'ذكر' : 'أنثى'}</div>
              ...
              {/* Full Name */}
              <div className={`input-container ${errors.fullName ? 'input-container--error' : ''}`}>
                <div className="input-wrapper">
                  <input
                    className="input"
                    type="text"
              ...
              {/* Date of Birth */}
              <div className={`input-container date-input ${errors.dateOfBirth ? 'input-container--error' : ''}`}>
                <div className="input-wrapper">
                  <input
                    className="input"
                    type="date"
                  ...
                  />
                  <label className="label">تاريخ ميلادك</label>
                </div>
                {errors.dateOfBirth && <span className="error-message">{errors.dateOfBirth}</span>}
              </div>

              {/* Email */}
              <div className={`input-container ${errors.email ? 'input-container--error' : ''}`}>
                <div className="input-wrapper">
                  <input
                    className="input"
                    type="email"
              ...
              {/* Chassis Number */}
              <div className={`input-container ${errors.chassisNumber ? 'input-container--error' : ''}`}>
                <div className="input-wrapper">
                  <input
