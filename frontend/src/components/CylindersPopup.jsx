...
const CylindersPopup = ({ isOpen, onClose }) => {
    ...
    <div className="popup-wrapper" style={{ zIndex: 1001 }}>
      <div className="popup rtl">
        ...
        <div className="istimara-popup">
          <h3>السلندرات</h3>
          <p>يمكن العثور على عدد السلندرات على الوجه الخلفي من الاستمارة (بطاقة تسجيل السيارة)</p>
          <div className="istimara">
            <img 
              src="/assets/images/cylinders.CLSHIRZF.png" 
              alt="موقع عدد السلندرات في الاستمارة" 
            />
          </div>
        </div>
